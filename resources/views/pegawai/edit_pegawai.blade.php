...
@section('content')
    ...
    <div class="container flex items-center justify-center">
        <div class="w-1/2 p-5 rounded-xl bg-blue-200">
            <form class="w-full max-w-lg mx-auto" action="{{ route('update.pegawai', $pegawai->id) }}" method="POST">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_pegawai" name="nama_pegawai" type="text" placeholder="Nama Pegawai" value="{{$pegawai->nama}}">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input value="{{$pegawai->tempat_lahir}}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="tempat_lahir" name="tempat_lahir" type="text" placeholder="Tempat Lahir">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input value="{{$pegawai->tanggal_lahir}}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="tanggal_lahir" name="tanggal_lahir" type="date">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input value="{{$pegawai->agama}}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="agama" name="agama" type="text" placeholder="Agama">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input value="{{$pegawai->alamat}}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="alamat" name="alamat" type="text" placeholder="Alamat">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <select class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_kelurahan" name="nama_kelurahan">
                            ...
                            @foreach ($allKelurahan as $item)
                                <option value="{{$item->nama_kelurahan}}" {{ $pegawai->kelurahan == $item->nama_kelurahan ? 'selected' : '' }}>{{$item->nama_kelurahan}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <select class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_kecamatan" name="nama_kecamatan">
                            ...
                            @foreach ($allKecamatan as $item)
                                <option value="{{$item->nama_kecamatan}}" {{ $pegawai->kecamatan == $item->nama_kecamatan ? 'selected' : '' }}>{{$item->nama_kecamatan}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <select class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_provinsi" name="nama_provinsi">
                            ...
                            @foreach ($allProvinsi as $item)
                                <option value="{{$item->nama_provinsi}}" {{ $pegawai->provinsi == $item->nama_provinsi ? 'selected' : '' }}>{{$item->nama_provinsi}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
