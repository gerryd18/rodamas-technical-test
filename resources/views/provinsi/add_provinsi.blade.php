...
@section('content')
    ...
    <div class="container flex items-center justify-center">
        <div class="w-1/2 p-5 rounded-xl bg-blue-200">
            <form class="w-full max-w-lg mx-auto" action="{{route('post.provinsi')}}" method="POST">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="kode" name="kode" type="text" placeholder="Kode" value="">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_provinsi" name="nama_provinsi" type="text" placeholder="Nama Provinsi">
                    </div>
                </div>
