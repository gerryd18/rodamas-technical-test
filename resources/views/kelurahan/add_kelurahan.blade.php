...
@section('content')
    ...
    <div class="container flex items-center justify-center">
        <div class="w-1/2 p-5 rounded-xl bg-blue-200">
            <form class="w-full max-w-lg mx-auto" action="{{route('post.kelurahan')}}" method="POST">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="nama_kelurahan" name="nama_kelurahan" type="text" placeholder="Nama Kelurahan">
                    </div>
                </div>
